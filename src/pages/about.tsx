...
export default function About() {
    return (
        <div className="m-3 md:mx-6">
            ...
            <div className="mx-3">
                <div
                    className="p-2 bg-gray-200 rounded-xl text-sm"
                    data-aos="fade-up"
                    data-aos-delay="300"
                >
                    <p>
                        Website ini adalah{" "}
                        <em className="font-medium">FANMADE</em> atau{" "}
                        <em className="font-medium">
                            BUKAN DARI OFFICIAL JKT48
                        </em>
                        , website ini dibuat bertujuan untuk memudahkan
                        orang-orang untuk melihat jadwal teater, histori live
                        member JKT48, serta semua fitur yang ada di dalam
                        website ini.
                    </p>
