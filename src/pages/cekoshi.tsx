...
export default function CekOshi() {
    ...
    return (
        <div
            ...
            style={{ backgroundImage: "url(/media/testtt.jpg)" }}
        >
            <div className="backdrop-blur-xl p-3 h-[30rem] rounded-lg text-gray-300">
                <h2 className="text-4xl font-semibold bg-clip-text text-transparent from-rose-500 via-blue-700 to-purple-600 bg-gradient-to-r background-animate flex justify-center">
                    Cek Oshi
                </h2>
                ...
                {!oshi && !isLoad && (
                    <form className="flex items-center mt-[8rem] flex-col mb-4" onSubmit={cekOshi}>
                        <input
                            ...
                            required
                        />
                        <button className="mt-3 p-2 rounded-md bg-gradient-to-r from-rose-500 to-purple-600 background-animate rounded-md">
                            Cek Oshi
                        </button>
                    </form>
                )}
                ...
                {!isLoad && oshi && (
                    <>
                        ...
                        <button
                            className="mt-[6rem] mb-4 p-2 rounded-md bg-gradient-to-r from-rose-500 to-purple-600 background-animate rounded-md"
                            onClick={resetOshi}
                        >
                            Cek oshi lagi
                        </button>
