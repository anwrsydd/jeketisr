...
export default async function HistoryLivePage({
    ...
    const { last_live, q, total_data, error }: Data = await getData(searchParams.q);
    if (error) {
        return (
            <div className="m-2">
                <p>Not found</p>
